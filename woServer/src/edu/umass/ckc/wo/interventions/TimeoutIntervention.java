 ...
 * an InterventionTimeoutEvent to the server after its wait period.  The InterventionTimeoutEvent gets sent back to the InterventionSelector that generated this
