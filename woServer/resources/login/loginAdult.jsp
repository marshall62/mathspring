...
<head>
    ...
    <link href="css/woColint.css" rel="stylesheet" type="text/css" />
    <link href="css/p7ccm04.css" rel="stylesheet" type="text/css" media="all" />
    <link href="../css/simple-slider.css" rel="stylesheet" type="text/css" />
    <!--[if lte IE 7]>
    <link href="/p7ie_fixes/p7ccm_ie.css" rel="stylesheet" type="text/css" media="all" />
    <![endif]-->
    <script type="text/javascript" src="js/p7EHCscripts.js"></script>
        ...
        <div id="p7CCM_1" class="p7CCM04 p7ccm04-fixed-980">
            ...
            <div class="p7ccm04-content-row p7ccm04-RGBA p7ccm-row">
                <div class="p7ccm04-1col-column1 p7ccm-col">
                    <div class="p7ccm04-1col-column1-cnt p7ccm04-content"> <img src="images/msinterfaceColandAdult.png" width="980" height="164" alt="MathSpring Math Tutor Adult" /></div>
                </div>
            </div>
